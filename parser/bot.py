...
def main_menu_keyboard(is_admin: bool = False) -> InlineKeyboardMarkup:
    """Главное меню"""
    buttons = [
        [InlineKeyboardButton("🔍 Начать парсинг", callback_data="start_parse")],
...
def admin_panel_keyboard() -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton("➕ Добавить подарок", callback_data="admin_add_gift")],
        [InlineKeyboardButton("🔍 Парсить по коллекции", callback_data="admin_parse_collection")],
